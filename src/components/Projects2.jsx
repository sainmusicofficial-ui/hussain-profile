...
const projects = [
  {
    ...
    description: "Healthcare startup focused on simplifying medical access through branding, website design, UI/UX, and mobile product development.",
    year: "2026",
  },
  {
    id: "ss-auditors",
    ...
    description: "Professional digital presence and company profile developed for a modern auditing and compliance firm.",
    year: "2024",
  },
  {
    ...
    description: "Premium restaurant brand built from the ground up including identity, website, and investor-ready presentation.",
    year: "2025",
  },
  {
    id: "ruyadar",
    ...
    category: "Branding",
    tags: ["Logo Design", "Website", "Company Profile", "Business Cards", "Social Media"],
    description: "Complete business branding ecosystem including website, company profile, print assets, and social media management.",
    year: "2025",
  },
  {
    id: "myas-and-co",
    ...
    description: "Professional company profile and website crafted to strengthen credibility and business positioning.",
    year: "2026",
  },
  {
    id: "olesome",
    ...
    description: "US-based e-commerce brand featuring a custom website experience and distinctive visual identity.",
    year: "2025",
  },
  {
    id: "aurenza",
    ...
    description: "Luxury-inspired visual identity and logo design created to establish a distinctive and memorable brand presence.",
    year: "2025",
  },
];
...
function ProjectCard({ project }) {
  ...
  const imageSrc = `/images/projects/${project.id}0.png`;
            ...
            <div className="w-full">
              <div className="flex items-center gap-2 mb-2">
                <span
                  ...
                  style={{ color: "#D7FF00", fontFamily: "var(--font-geist-mono)" }}
                >
                  {project.year}
                </span>
                ...
                <span
                  className="text-[10px] tracking-wider uppercase"
                  style={{ color: "#8A8A8A", fontFamily: "var(--font-geist-mono)" }}
                >
                  {project.category}
                </span>
              </div>
