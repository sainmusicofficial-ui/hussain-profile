...
// ─── Timeline Row ─────────────────────────────────────────────────────────────
function TimelineRow({ year, title, desc, isLast, isMobile }) {
  ...
  return (
    ...
    >
      <span style={{
        fontWeight: "800",
        fontSize: isMobile ? "clamp(28px, 7vw, 40px)" : "clamp(42px, 4vw, 60px)",
        lineHeight: "1",
      ...
      <div>
        <h3 style={{ color: "#ffffff", fontWeight: "700", fontSize: isMobile ? "16px" : "20px", marginBottom: "8px" }}>
          {title}
        </h3>
        <p style={{ color: "#666666", fontSize: isMobile ? "13px" : "15px", lineHeight: "1.6", fontWeight: "400" }}>
          {desc}
        </p>
      </div>
    </div>
  ...
  return (
    ...
    >
      <div style={{
        ...
        marginBottom: "28px", color: "#D7FF00",
...
function SkillTag({ name, color = "#D7FF00" }) {
  ...
  return (
    ...
    >
      ...
      <span style={{ color: hovered ? "#ffffff" : "#999999", fontSize: "13px", fontWeight: "500", transition: "color 0.25s ease" }}>
        {name}
      </span>
    </div>
  );
...
export default function About2() {
  ...
  const sectionPaddingX = isMobile ? "24px" : isTablet ? "40px" : "5vw";
  const sectionPadding = `${isMobile ? "80px" : "100px"} ${sectionPaddingX}`;
    ...
    <div>
      ...
      >
        ...
        <div
          style={{
            ...
            paddingTop: isMobile ? "120px" : isTablet ? "150px" : "180px",
        ...
        >
          <FadeIn delay={0}>
            <p style={{
              ...
              color: "#D7FF00", marginBottom: "24px",
            }}>
              // ABOUT
            </p>
          </FadeIn>
          ...
          <FadeIn delay={100}>
            <h1 style={{
              fontWeight: "800",
              fontSize: isMobile ? "clamp(36px, 10vw, 56px)" : isTablet ? "clamp(48px, 7vw, 72px)" : "clamp(60px, 6vw, 100px)",
      ...
      <section style={{ background: "#0a0a0a" }}>
        <div style={{
          ...
          {/* Reference uses lg:grid-cols-2 gap-16 lg:gap-24 — always two columns on non-mobile */}
          <div style={{
            display: "grid",
            ...
            <FadeIn direction="left">
              <div>
                ...
                <h2 style={{
                  ...
                  lineHeight: "1.05", marginBottom: "32px", color: "#ffffff",
                  letterSpacing: "-0.02em",
                }}>
                  From curiosity to craft
                </h2>
                <div style={{ display: "flex", flexDirection: "column", gap: "24px", color: "rgba(255,255,255,0.5)", fontSize: isMobile ? "14px" : "15px", lineHeight: "1.8", fontWeight: "400" }}>
            ...
            {/* RIGHT — Quick Facts card (reference: glass rounded-2xl p-8 relative overflow-hidden) */}
            <FadeIn direction="right" delay={150}>
              <div style={{
                ...
                {/* Glow in top-right like reference */}
                <div style={{
                ...
                <p style={{
                  fontFamily: "monospace", textTransform: "uppercase",
                  letterSpacing: "3px", fontSize: "12px",
                  color: "#D7FF00", marginBottom: "32px",
                }}>
                  // QUICK FACTS
                </p>
                <div style={{ display: "flex", flexDirection: "column", gap: "0px" }}>
                  {[
                    ...
                    <div key={label} style={{
                      ...
                      <span style={{ fontFamily: "monospace", color: "rgba(255,255,255,0.3)", fontSize: "13px" }}>{label}</span>
                      <span style={{ color: "#ffffff", fontWeight: "600", fontSize: isMobile ? "13px" : "15px", textAlign: "right" }}>{value}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section style={{ background: "#0a0a0a" }}>
        <div style={{ padding: sectionPadding, boxSizing: "border-box" }}>
          <FadeIn>
            <p style={{ fontFamily: "monospace", textTransform: "uppercase", letterSpacing: "3px", fontSize: "13px", color: "#D7FF00", marginBottom: "16px" }}>
              // PHILOSOPHY
            </p>
            <h2 style={{ fontWeight: "800", fontSize: isMobile ? "clamp(32px, 8vw, 48px)" : "clamp(38px, 4vw, 56px)", lineHeight: "1.05", color: "#ffffff", marginBottom: "48px" }}>
              What I believe in
            </h2>
          </FadeIn>
      ...
      <section style={{ background: "#0a0a0a" }}>
        <div style={{ padding: sectionPadding, boxSizing: "border-box" }}>
          <FadeIn>
            ...
            <h2 style={{ fontWeight: "800", fontSize: isMobile ? "clamp(32px, 8vw, 48px)" : "clamp(38px, 4vw, 56px)", lineHeight: "1.05", color: "#ffffff", marginBottom: "16px" }}>
              Skills & Tools
            </h2>
            <p style={{ color: "#666666", fontSize: isMobile ? "14px" : "16px", lineHeight: "1.7", maxWidth: "520px", marginBottom: "48px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "40px" }}>
            {[
              { label: "Design", color: "#D7FF00", skills: ["Figma", "Adobe Illustrator", "Photoshop", "After Effects", "Framer", "Spline"] },
              { label: "Development", color: "#00F0FF", skills: ["React", "Next.js", "Tailwind CSS", "TypeScript", "Framer Motion", "GSAP"] },
              { label: "Strategy & Direction", color: "#B794F4", skills: ["Brand Strategy", "UI/UX Design", "Design Systems", "Creative Direction", "Content Strategy"] },
            ].map((group, i) => (
              <FadeIn key={group.label} delay={i * 100}>
                <div>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
                    {group.skills.map((s) => (
                      <SkillTag key={s} name={s} color={group.color} />
                    ))}
                  </div>
                </div>
              </FadeIn>
          ...
          <div>
            {[
              ...
              <FadeIn key={item.year} delay={i * 80}>
                <TimelineRow {...item} isLast={i === arr.length - 1} isMobile={isMobile} />
              </FadeIn>
            ))}
          </div>
        </div>
